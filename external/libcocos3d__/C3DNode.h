...
#define NODE_DIRTY_ALL (NODE_DIRTY_WORLD | NODE_DIRTY_BOUNDS_AABB | NODE_DIRTY_BOUNDS_OBB)
    ...
    public:
         ...
         */
        virtual void setActionManager(C3DActionManager* actionManager);
        /**
         ...
         */
        virtual C3DActionManager* getActionManager();
         ...
         */
        C3DAction* runAction(C3DAction* action);
         ...
         */
        void stopAction(C3DAction* action);
         ...
         */
        C3DAction* getActionByTag(int tag);
    ...
    protected:
        ...
        C3DActionManager *_actionManager;
