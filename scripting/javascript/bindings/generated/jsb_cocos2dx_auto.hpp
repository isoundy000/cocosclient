...
JSBool js_cocos2dx_CCAction_setUserData(JSContext *cx, uint32_t argc, jsval *vp);
JSBool js_cocos2dx_CCAction_getUserData(JSContext *cx, uint32_t argc, jsval *vp);
...
extern JSClass  *jsb_CCRemoveSelf_class;
extern JSObject *jsb_CCRemoveSelf_prototype;

JSBool js_cocos2dx_CCRemoveSelf_constructor(JSContext *cx, uint32_t argc, jsval *vp);
void js_cocos2dx_CCRemoveSelf_finalize(JSContext *cx, JSObject *obj);
void js_register_cocos2dx_CCRemoveSelf(JSContext *cx, JSObject *global);
void register_all_cocos2dx(JSContext* cx, JSObject* obj);
JSBool js_cocos2dx_CCRemoveSelf_init(JSContext *cx, uint32_t argc, jsval *vp);
JSBool js_cocos2dx_CCRemoveSelf_reverse(JSContext *cx, uint32_t argc, jsval *vp);
JSBool js_cocos2dx_CCRemoveSelf_update(JSContext *cx, uint32_t argc, jsval *vp);
JSBool js_cocos2dx_CCRemoveSelf_create(JSContext *cx, uint32_t argc, jsval *vp);
JSBool js_cocos2dx_CCRemoveSelf_CCRemoveSelf(JSContext *cx, uint32_t argc, jsval *vp);
...
void register_all_cocos2dx(JSContext* cx, JSObject* obj);
JSBool js_cocos2dx_CCTransitionScene_getInScene(JSContext *cx, uint32_t argc, jsval *vp);
...
void register_all_cocos2dx(JSContext* cx, JSObject* obj);
JSBool js_cocos2dx_CCParticleSystemQuad_getParticleIndex(JSContext *cx, uint32_t argc, jsval *vp);
JSBool js_cocos2dx_CCParticleSystemQuad_getQuads(JSContext *cx, uint32_t argc, jsval *vp);
...
extern JSClass  *jsb_CCUserDefault_class;
extern JSObject *jsb_CCUserDefault_prototype;

JSBool js_cocos2dx_CCUserDefault_constructor(JSContext *cx, uint32_t argc, jsval *vp);
void js_cocos2dx_CCUserDefault_finalize(JSContext *cx, JSObject *obj);
void js_register_cocos2dx_CCUserDefault(JSContext *cx, JSObject *global);
void register_all_cocos2dx(JSContext* cx, JSObject* obj);
JSBool js_cocos2dx_CCUserDefault_setIntegerForKey(JSContext *cx, uint32_t argc, jsval *vp);
JSBool js_cocos2dx_CCUserDefault_getFloatForKey(JSContext *cx, uint32_t argc, jsval *vp);
JSBool js_cocos2dx_CCUserDefault_getBoolForKey(JSContext *cx, uint32_t argc, jsval *vp);
JSBool js_cocos2dx_CCUserDefault_flush(JSContext *cx, uint32_t argc, jsval *vp);
JSBool js_cocos2dx_CCUserDefault_setDoubleForKey(JSContext *cx, uint32_t argc, jsval *vp);
JSBool js_cocos2dx_CCUserDefault_setFloatForKey(JSContext *cx, uint32_t argc, jsval *vp);
JSBool js_cocos2dx_CCUserDefault_autorelease(JSContext *cx, uint32_t argc, jsval *vp);
JSBool js_cocos2dx_CCUserDefault_getStringForKey(JSContext *cx, uint32_t argc, jsval *vp);
JSBool js_cocos2dx_CCUserDefault_setStringForKey(JSContext *cx, uint32_t argc, jsval *vp);
JSBool js_cocos2dx_CCUserDefault_getIntegerForKey(JSContext *cx, uint32_t argc, jsval *vp);
JSBool js_cocos2dx_CCUserDefault_getDoubleForKey(JSContext *cx, uint32_t argc, jsval *vp);
JSBool js_cocos2dx_CCUserDefault_setBoolForKey(JSContext *cx, uint32_t argc, jsval *vp);
JSBool js_cocos2dx_CCUserDefault_initXMLFilePath(JSContext *cx, uint32_t argc, jsval *vp);
JSBool js_cocos2dx_CCUserDefault_isXMLFileExist(JSContext *cx, uint32_t argc, jsval *vp);
JSBool js_cocos2dx_CCUserDefault_sharedUserDefault(JSContext *cx, uint32_t argc, jsval *vp);
JSBool js_cocos2dx_CCUserDefault_purgeSharedUserDefault(JSContext *cx, uint32_t argc, jsval *vp);
JSBool js_cocos2dx_CCUserDefault_getXMLFilePath(JSContext *cx, uint32_t argc, jsval *vp);
JSBool js_cocos2dx_CCUserDefault_createXMLFile(JSContext *cx, uint32_t argc, jsval *vp);
JSBool js_cocos2dx_CCUserDefault_CCUserDefault(JSContext *cx, uint32_t argc, jsval *vp);
